...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/adaptive_icon_monochrome.png
  AssetGenImage get adaptiveIconMonochrome =>
      const AssetGenImage('assets/images/adaptive_icon_monochrome.png');
...
class $AssetsSvgsGen {
  ...
  /// File path: assets/svgs/key-solid-full.svg
  SvgGenImage get keySolidFull =>
      const SvgGenImage('assets/svgs/key-solid-full.svg');

  /// List of all assets
  List<SvgGenImage> get values => [keySolidFull];
}
