...
class ImportMasterKeyDialog extends StatelessWidget {
  const ImportMasterKeyDialog({super.key, required this.importData, required this.cubit});

  final ImportExportDataCubit cubit;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ImportExportDataCubit, ImportExportDataState>(
      bloc: cubit,
